//goal: convert a huffkey to an int
...
public class HuffKeyToInt {
  ...
  public int convert(String huffKey) {
  ...
  public int keyToInt(String pureKey) {
  ...
  public int findKeySize(String huffKey) {
  ...
  public int convert10sDigit(char digitKey) {
  ...
  public int convert1sDigit(char digitKey) {
  ...
  public  boolean is2through9(char character) {
    int input = (int)character;
