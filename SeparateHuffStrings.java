// goal: test class to separate huffman strings into an arraylist of huffkeys
import java.util.*;

public class SeparateHuffStrings {
  public SeparateHuffStrings() {};

  // returns an arraylist after separating the message
  public static ArrayList<String> separate(String encodedMessage) {
  ...
  public static int determineKeySize(char firstDigit, int i, char[] charArray) {
    int size = 0;
  ...
  public static int findNextSpace(int start, char[] message) {
  ...
  public static boolean is2through9(char character) {
    int input = (int)character;
